...
from app.core.models import ProductInDB, NotificationPayload
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                if attempt == self.max_retries - 1:  # Last attempt
                    ...
                    logger.info(f"Retrying after {constants.SCRAPE_PAGE_RETRY_DELAY} seconds.")
                ...
                send_notification.delay(NotificationPayload(notification_message=err_message))
        return ""
    ...
    def _get_product_list(self, html_page:str)-> list[ProductInDB]:
        ...
        for product_html in products_html:
            try:
                ...
                product_name=product_html.find('h2', class_='woo-loop-product__title').get_text().strip(".")
                ...
                product_list.append(ProductInDB(
                    price=price,
...
def run_scrape_task(page_num:int, proxy:str|None, db_connection:TextIOWrapper):
    ...
    successfull_message = f"Fetched {len(products_fetched)} product info from page {page_num}."
